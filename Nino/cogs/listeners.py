...
class Listeners(commands.Cog):
    ...
    async def send_error(self, ctx: commands.Context, content: str) -> discord.Message:
        return await ctx.send(embed=discord.Embed(description=content, color=discord.Color.red()))
    
    async def forward_to_owners(self, ctx: commands.Context, e: commands.CommandError) -> None:
