"""
Shoutout Soheab: https://gist.github.com/Soheab/f226fc06a3468af01ea3168c95b30af8#file-1-paginator-py
"""
    ...
    async def start(
        ...
        if isinstance(obj, discord.Interaction):
            if obj.response.is_done():
                ...
                callback = await obj.response.send_message(**kwargs, **send_kwargs)
                if callback and isinstance(
                    callback.resource, discord.InteractionMessage
                ):
